        ...
        <div class=" col-md-7">
            ...
            <form role="form" action="${contextPath}/autores.do" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="codigo"
                               id="codigo" value="${autor.codigoAutor}" readonly placeholder="Ingresa el codigo del autor" >
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="nombre"
                               id="nombre" value="${autor.nombreAutor}" placeholder="Ingresa el nombre del autor" >
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="contacto"
                               value="${autor.nacionalidad}" name="nacionalidad" placeholder="Ingresa la nacionalidad del autor">
                ...
                <a class="btn btn-danger"
                   href="${contextPath}/autores.do?op=listar">Cancelar</a>
            </form>
        </div>
    </div>
</div>
